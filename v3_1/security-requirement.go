...
func (o *SecurityRequirement) validateSpec(_ string, validator *common.Validator) []*common.validationError { //nolint: unparam // by design
	for k := range *o {
		validator.visited[common.joinLoc("#", "components", "securitySchemes", k)] = true
	}
