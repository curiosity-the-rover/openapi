...
func TestComponents_Add(t *testing.T) {
	for _, tt := range []struct {
		...
		check  func(tb testing.TB, c *v3_1.Components)
	}{
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewSchemaBuilder().Title("test").Build()
				return "testSchema", o
			},
			check: func(tb testing.TB, c *v3_1.Components) {
				tb.Helper()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewResponseBuilder().Description("test").Build()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewParameterBuilder().Description("test").Build()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewExampleBuilder().Description("test").Build()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewRequestBodyBuilder().Description("test").Build()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewHeaderBuilder().Description("test").Build()
				return "testHeader", o
			},
			check: func(tb testing.TB, c *v3_1.Components) {
				tb.Helper()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := &v3_1.SecurityScheme{
					Description: "test",
				}
				return "testSecurityScheme", common.NewRefOrExtSpec[v3_1.SecurityScheme](o)
			},
			check: func(tb testing.TB, c *v3_1.Components) {
				tb.Helper()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewLinkBuilder().Description("test").Build()
				return "testLink", o
			},
			check: func(tb testing.TB, c *v3_1.Components) {
				tb.Helper()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewCallbackBuilder().AddPathItem(
					"testPath",
					v3_1.NewPathItemBuilder().Description("test").Build(),
				).Build()
		...
		},
		{
			...
			create: func(tb testing.TB) (string, any) {
				...
				o := v3_1.NewPathItemBuilder().Description("test").Build()
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.check(t, (&v3_1.Components{}).Add(name, obj))
		})
	}
}
