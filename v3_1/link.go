...
type Link struct {
	...
	Server *common.Extendable[Server] `json:"server,omitempty" yaml:"server,omitempty"`
...
func (o *Link) validateSpec(location string, validator *common.Validator) []*common.validationError {
	var errs []*common.validationError
	if o.OperationRef != "" && o.OperationID != "" {
		errs = append(errs, common.newValidationError(common.joinLoc(location, "operationRef&operationId"), common.ErrMutuallyExclusive))
	}
	if o.OperationID != "" {
		id := common.joinLoc("operations", o.OperationID)
		if !validator.visited[id] {
			validator.linkToOperationID[common.joinLoc(location, "operationId")] = o.OperationID
		}
	}
	...
	//}
	if o.Server != nil {
		errs = append(errs, o.Server.validateSpec(common.joinLoc(location, "server"), validator)...)
	}
	return errs
}

type LinkBuilder struct {
	spec *common.RefOrSpec[common.Extendable[Link]]
}

func NewLinkBuilder() *LinkBuilder {
	return &LinkBuilder{
		spec: common.NewRefOrExtSpec[Link](&Link{}),
	}
}

func (b *LinkBuilder) Build() *common.RefOrSpec[common.Extendable[Link]] {
	return b.spec
}
...
func (b *LinkBuilder) Server(v *common.Extendable[Server]) *LinkBuilder {
