...
func (o *OAuthFlow) validateSpec(path string, validator *common.Validator) []*common.validationError {
	// all the validations are done in the parent object
	return nil
}

type OAuthFlowBuilder struct {
	spec *common.Extendable[OAuthFlow]
}

func NewOAuthFlowBuilder() *OAuthFlowBuilder {
	return &OAuthFlowBuilder{
		spec: common.NewExtendable[OAuthFlow](&OAuthFlow{}),
	}
}

func (b *OAuthFlowBuilder) Build() *common.Extendable[OAuthFlow] {
	return b.spec
}
