...
func (o *Example) validateSpec(location string, _ *common.Validator) []*common.validationError {
	var errs []*common.validationError
	if o.Value != nil && o.ExternalValue != "" {
		errs = append(errs, common.newValidationError(common.joinLoc(location, "value&externalValue"), common.ErrMutuallyExclusive))
	}
	if err := common.checkURL(o.ExternalValue); err != nil {
		errs = append(errs, common.newValidationError(common.joinLoc(location, "externalValue"), err))
	}
...
type ExampleBuilder struct {
	spec *common.RefOrSpec[common.Extendable[Example]]
}

func NewExampleBuilder() *ExampleBuilder {
	return &ExampleBuilder{
		spec: common.NewRefOrExtSpec[Example](&Example{}),
	}
}

func (b *ExampleBuilder) Build() *common.RefOrSpec[common.Extendable[Example]] {
	return b.spec
}
