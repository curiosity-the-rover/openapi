...
type Schema struct {
	...
	Defs          map[string]*common.RefOrSpec[Schema] `json:"$defs,omitempty"          yaml:"$defs,omitempty"`
	...
	Type *common.SingleOrArray[string] `json:"type,omitempty" yaml:"type,omitempty"`
	...
	ContentSchema *common.RefOrSpec[Schema] `json:"contentSchema,omitempty" yaml:"contentSchema,omitempty"`
	...
	Not *common.RefOrSpec[Schema] `json:"not,omitempty" yaml:"not,omitempty"`
	// To validate against allOf, the given data must be valid against all of the given subschemas.
	//
	// https://json-schema.org/understanding-json-schema/reference/combining.html#allof
	AllOf []*common.RefOrSpec[Schema] `json:"allOf,omitempty" yaml:"allOf,omitempty"`
	// To validate against anyOf, the given data must be valid against any (one or more) of the given subschemas.
	//
	// https://json-schema.org/understanding-json-schema/reference/combining.html#anyof
	AnyOf []*common.RefOrSpec[Schema] `json:"anyOf,omitempty" yaml:"anyOf,omitempty"`
	// To validate against oneOf, the given data must be valid against exactly one of the given subschemas.
	//
	// https://json-schema.org/understanding-json-schema/reference/combining.html#oneof
	OneOf []*common.RefOrSpec[Schema] `json:"oneOf,omitempty" yaml:"oneOf,omitempty"`
	...
	DependentSchemas map[string]*common.RefOrSpec[Schema] `json:"dependentSchemas,omitempty" yaml:"dependentSchemas,omitempty"`

	// https://json-schema.org/understanding-json-schema/reference/conditionals.html#if-then-else
	If   *common.RefOrSpec[Schema] `json:"if,omitempty"   yaml:"if,omitempty"`
	Then *common.RefOrSpec[Schema] `json:"then,omitempty" yaml:"then,omitempty"`
	Else *common.RefOrSpec[Schema] `json:"else,omitempty" yaml:"else,omitempty"`
	...
	Items *common.BoolOrSchema `json:"items,omitempty" yaml:"items,omitempty"`
	...
	UnevaluatedItems *common.BoolOrSchema `json:"unevaluatedItems,omitempty" yaml:"unevaluatedItems,omitempty"`
	...
	Contains    *common.RefOrSpec[Schema] `json:"contains,omitempty"    yaml:"contains,omitempty"`
	...
	PrefixItems []*common.RefOrSpec[Schema] `json:"prefixItems,omitempty" yaml:"prefixItems,omitempty"`
	...
	Properties map[string]*common.RefOrSpec[Schema] `json:"properties,omitempty" yaml:"properties,omitempty"`
	...
	PatternProperties map[string]*common.RefOrSpec[Schema] `json:"patternProperties,omitempty" yaml:"patternProperties,omitempty"`
	...
	AdditionalProperties *common.BoolOrSchema `json:"additionalProperties,omitempty" yaml:"additionalProperties,omitempty"`
	...
	UnevaluatedProperties *common.BoolOrSchema `json:"unevaluatedProperties,omitempty" yaml:"unevaluatedProperties,omitempty"`
	...
	PropertyNames *common.RefOrSpec[Schema] `json:"propertyNames,omitempty" yaml:"propertyNames,omitempty"`
	...
	// xml
	XML *common.Extendable[XML] `json:"xml,omitempty" yaml:"xml,omitempty"`
...
func (o *Schema) GetExt(name string) any {
	...
	if !strings.HasPrefix(name, common.ExtensionPrefix) {
		name = common.ExtensionPrefix + name
	}
...
func (o *Schema) validateSpec(location string, validator *common.Validator) []*common.validationError {
	var errs []*common.validationError

	if o.Discriminator != nil {
		errs = append(errs, o.Discriminator.validateSpec(common.joinLoc(location, "discriminator"), validator)...)
	}
	if o.XML != nil {
		errs = append(errs, o.XML.validateSpec(common.joinLoc(location, "xml"), validator)...)
	}
	...
	if o.Not != nil {
		errs = append(errs, o.Not.validateSpec(common.joinLoc(location, "not"), validator)...)
	}
	if o.AllOf != nil {
		for i, v := range o.AllOf {
			errs = append(errs, v.validateSpec(common.joinLoc(location, "allOf", i), validator)...)
		}
	}
	if o.AnyOf != nil {
		for i, v := range o.AnyOf {
			errs = append(errs, v.validateSpec(common.joinLoc(location, "anyOf", i), validator)...)
		}
	}
	if o.OneOf != nil {
		for i, v := range o.OneOf {
			errs = append(errs, v.validateSpec(common.joinLoc(location, "oneOf", i), validator)...)
		}
	}
	...
	if o.Schema != "" {
		if u, err := url.Parse(o.Schema); err != nil || u == nil || u.Scheme == "" {
			errs = append(errs, common.newValidationError(common.joinLoc(location, "schema"), "must be an absolute URI, got '%s'", o.Schema))
		}
	}
	if len(o.Defs) > 0 {
		for k, v := range o.Defs {
			errs = append(errs, v.validateSpec(common.joinLoc(location, "defs", k), validator)...)
		}
	}
	if o.Type != nil {
		switch len(*o.Type) {
		...
		case 1:
			...
			default:
				errs = append(errs, common.newValidationError(common.joinLoc(location, "type"), "invalid value, expected one of [%s, %s, %s, %s, %s, %s, %s], but got '%s'", StringType, NumberType, IntegerType, BooleanType, ObjectType, ArrayType, NullType, v))
			}
		default:
			for i, v := range *o.Type {
				...
				case StringType, NumberType, IntegerType, BooleanType, ObjectType, ArrayType, NullType:
				default:
					errs = append(errs, common.newValidationError(common.joinLoc(location, "type", i), "invalid value, expected one of [%s, %s, %s, %s, %s, %s, %s], but got '%s'", StringType, NumberType, IntegerType, BooleanType, ObjectType, ArrayType, NullType, v))
				}
			}
		}
	}
	...
	if o.ContentSchema != nil {
		errs = append(errs, o.ContentSchema.validateSpec(common.joinLoc(location, "contentSchema"), validator)...)
	}
	if o.ContentEncoding != "" {
		...
		default:
			errs = append(errs, common.newValidationError(common.joinLoc(location, "contentEncoding"), "invalid value, expected one of [%s, %s, %s, %s, %s, %s, %s], but got '%s'", SevenBitEncoding, EightBitEncoding, BinaryEncoding, QuotedPrintableEncoding, Base16Encoding, Base32Encoding, Base64Encoding, o.ContentEncoding))
		}
	}
	...
	if o.Default != nil {
		if !validator.opts.doNotValidateDefaultValues {
			if e := validator.ValidateData(location, o.Default); e != nil {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "default"), e))
			}
		}
		if o.Const != nil && !reflect.DeepEqual(o.Default, o.Const) {
			errs = append(errs, common.newValidationError(common.joinLoc(location, "default"), "invalid value, expected to be equal to const value: %v", o.Const))
		}
		if len(o.Enum) > 0 {
			var found bool
			...
			if !found {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "default"), "invalid value, expected one of enum values: %v", o.Enum))
			}
		}
	}
		...
		for i, oi := range o.Enum {
			for j, oj := range o.Enum[i+1:] {
				if reflect.DeepEqual(oi, oj) {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "enum", i+1+j), "duplicate value found in enum: %v", oj))
					break
				}
			}
		}
	...
	if o.Const != nil && len(o.Enum) > 0 {
		errs = append(errs, common.newValidationError(common.joinLoc(location, "const"), "cannot be used together with enum"))
	}
	...
	if o.Type == nil {
		...
		if o.Properties != nil {
			for k, v := range o.Properties {
				errs = append(errs, v.validateSpec(common.joinLoc(location, "properties", k), validator)...)
			}
		}
		if o.PatternProperties != nil {
			for k, v := range o.PatternProperties {
				errs = append(errs, v.validateSpec(common.joinLoc(location, "patternProperties", k), validator)...)
				if _, err := regexp.Compile(k); err != nil {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "patternProperties", k), err))
				}
			}
		}
		if o.AdditionalProperties != nil {
			errs = append(errs, o.AdditionalProperties.validateSpec(common.joinLoc(location, "additionalProperties"), validator)...)
		}
		if o.UnevaluatedProperties != nil {
			errs = append(errs, o.UnevaluatedProperties.validateSpec(common.joinLoc(location, "unevaluatedProperties"), validator)...)
		}
		if o.PropertyNames != nil {
			errs = append(errs, o.PropertyNames.validateSpec(common.joinLoc(location, "propertyNames"), validator)...)
		}
		// array-like keywords
		if o.Items != nil {
			errs = append(errs, o.Items.validateSpec(common.joinLoc(location, "items"), validator)...)
		}
		if o.UnevaluatedItems != nil {
			errs = append(errs, o.UnevaluatedItems.validateSpec(common.joinLoc(location, "unevaluatedItems"), validator)...)
		}
		if o.Contains != nil {
			errs = append(errs, o.Contains.validateSpec(common.joinLoc(location, "contains"), validator)...)
		}
		if len(o.PrefixItems) > 0 {
			for i, v := range o.PrefixItems {
				errs = append(errs, v.validateSpec(common.joinLoc(location, "prefixItems", i), validator)...)
			}
		}
		return errs
	}
	for _, t := range *o.Type {
		...
		case ArrayType: // JsonSchemaTypeArray
			...
			if o.MinItems != nil && *o.MinItems < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "minItems"), "must be greater than or equal to 0"))
			}
			if o.MaxItems != nil && *o.MaxItems < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maxItems"), "must be greater than or equal to 0"))
				if o.MinItems != nil && *o.MaxItems < *o.MinItems {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "maxItems"), "must be greater than or equal to minItems"))
				}
			}
			if o.UnevaluatedItems != nil {
				errs = append(errs, o.UnevaluatedItems.validateSpec(common.joinLoc(location, "unevaluatedItems"), validator)...)
			...
			if o.MinContains != nil && *o.MinContains < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "minContains"), "must be greater than or equal to 0"))
			}
			if o.MaxContains != nil && *o.MaxContains < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maxContains"), "must be greater than or equal to 0"))
				if o.MinContains != nil && *o.MaxContains < *o.MinContains {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "maxContains"), "must be greater than or equal to minContains"))
				}
			}
			if (o.MinContains != nil || o.MaxContains != nil) && o.Contains == nil {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "contains"), "'contains' keyword is required when using minContains or maxContains"))
			}
			if len(o.PrefixItems) > 0 {
				for i, v := range o.PrefixItems {
					errs = append(errs, v.validateSpec(common.joinLoc(location, "prefixItems", i), validator)...)
		...
		case ObjectType: // JsonSchemaTypeObject
			...
			if o.MinProperties != nil && *o.MinProperties < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "minProperties"), "must be greater than or equal to 0"))
			}
			if o.MaxProperties != nil && *o.MaxProperties < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maxProperties"), "must be greater than or equal to 0"))
				if o.MinProperties != nil && *o.MaxProperties < *o.MinProperties {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "maxProperties"), "must be greater than or equal to minProperties"))
				}
			}
			if len(o.Required) > 0 {
				for i, v := range o.Required {
					if _, ok := o.Properties[v]; !ok {
						errs = append(errs, common.newValidationError(common.joinLoc(location, "required", i), "must be a property in properties"))
					}
				}
			}
		case NumberType, IntegerType: // JsonSchemaTypeNumber
			if o.MultipleOf != nil && *o.MultipleOf <= 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "multipleOf"), "must be greater than 0"))
			}
			if o.Minimum != nil && o.Maximum != nil && *o.Maximum < *o.Minimum {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maximum"), "must be greater than or equal to minimum"))
			}
			if o.ExclusiveMinimum != nil && o.ExclusiveMaximum != nil && *o.ExclusiveMaximum < *o.ExclusiveMinimum {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "exclusiveMaximum"), "must be greater than exclusiveMinimum"))
			}
			if o.Minimum != nil && o.ExclusiveMinimum != nil {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "minimum&exclusiveMinimum"), common.ErrMutuallyExclusive))
			}
			if o.Maximum != nil && o.ExclusiveMaximum != nil {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maximum&exclusiveMaximum"), common.ErrMutuallyExclusive))
			}
		case StringType: // JsonSchemaTypeString
			if o.MinLength != nil && *o.MinLength < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "minLength"), "must be greater than or equal to 0"))
			}
			if o.MaxLength != nil && *o.MaxLength < 0 {
				errs = append(errs, common.newValidationError(common.joinLoc(location, "maxLength"), "must be greater than or equal to 0"))
				if o.MinLength != nil && *o.MaxLength < *o.MinLength {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "maxLength"), "must be greater than or equal to minLength"))
				}
			}
			if o.Pattern != "" {
				if _, err := regexp.Compile(o.Pattern); err != nil {
					errs = append(errs, common.newValidationError(common.joinLoc(location, "pattern"), err))
				}
			}
		}
	}
...
type SchemaBuilder struct {
	spec *common.RefOrSpec[Schema]
}

func NewSchemaBuilder() *SchemaBuilder {
	return &SchemaBuilder{
		spec: common.NewRefOrSpec[Schema](&Schema{}),
	}
}

func (b *SchemaBuilder) Build() *common.RefOrSpec[Schema] {
	if b.spec.Ref != nil {
		b.spec.Spec = nil
	}
	return b.spec
...
func (b *SchemaBuilder) Defs(v map[string]*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.Defs = v
...
func (b *SchemaBuilder) AddDef(name string, value *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	if b.spec.Spec.Defs == nil {
		b.spec.Spec.Defs = make(map[string]*common.RefOrSpec[Schema], 1)
	}
...
func (b *SchemaBuilder) Type(v ...string) *SchemaBuilder {
	...
	b.spec.Spec.Type = common.NewSingleOrArray[string](v...)
	return b
}
...
func (b *SchemaBuilder) ContentSchema(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) Not(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.Not = v
...
func (b *SchemaBuilder) AllOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.AllOf = v
...
func (b *SchemaBuilder) AddAllOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) AnyOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.AnyOf = v
...
func (b *SchemaBuilder) AddAnyOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) OneOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.OneOf = v
...
func (b *SchemaBuilder) AddOneOf(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) DependentSchemas(v map[string]*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) AddDependentSchema(name string, value *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	if b.spec.Spec.DependentSchemas == nil {
		b.spec.Spec.DependentSchemas = make(map[string]*common.RefOrSpec[Schema], 1)
	}
	b.spec.Spec.DependentSchemas[name] = value
	return b
}

func (b *SchemaBuilder) If(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.If = v
...
func (b *SchemaBuilder) Then(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.Then = v
...
func (b *SchemaBuilder) Else(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.Else = v
...
func (b *SchemaBuilder) Items(v *common.BoolOrSchema) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.Items = v
...
func (b *SchemaBuilder) UnevaluatedItems(v *common.BoolOrSchema) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) Contains(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) PrefixItems(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) AddPrefixItems(v ...*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) Properties(v map[string]*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) AddProperty(name string, value *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	if b.spec.Spec.Properties == nil {
		b.spec.Spec.Properties = make(map[string]*common.RefOrSpec[Schema], 1)
	}
	b.spec.Spec.Properties[name] = value
	return b
}

func (b *SchemaBuilder) PatternProperties(v map[string]*common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) AddPatternProperty(name string, value *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	if b.spec.Spec.PatternProperties == nil {
		b.spec.Spec.PatternProperties = make(map[string]*common.RefOrSpec[Schema], 1)
	}
	b.spec.Spec.PatternProperties[name] = value
	return b
}

func (b *SchemaBuilder) AdditionalProperties(v *common.BoolOrSchema) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) UnevaluatedProperties(v *common.BoolOrSchema) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) PropertyNames(v *common.RefOrSpec[Schema]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
...
func (b *SchemaBuilder) XML(v *common.Extendable[XML]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
	b.spec.Spec.XML = v
...
func (b *SchemaBuilder) ExternalDocs(v *common.Extendable[ExternalDocs]) *SchemaBuilder {
	if b.spec.Ref != nil {
		return b
	}
