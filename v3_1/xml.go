...
func (o *XML) validateSpec(path string, validator *common.Validator) []*common.validationError {
	return nil // nothing to validate
}

type XMLBuilder struct {
	spec *common.Extendable[XML]
}

func NewXMLBuilder() *XMLBuilder {
	return &XMLBuilder{
		spec: common.NewExtendable[XML](&XML{}),
	}
}

func (b *XMLBuilder) Build() *common.Extendable[XML] {
	return b.spec
}
